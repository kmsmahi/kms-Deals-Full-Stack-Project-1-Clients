                  ...
                  <tr key={bid._id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                        <img
                          src={bid.image || "https://via.placeholder.com/80"}
                          alt={bid.title || "Product"}
                          className="w-12 h-12 rounded-xl object-cover border border-gray-200 shadow-sm"
                        />
                        <div>
                          <p className="font-bold text-gray-900 line-clamp-1">
                            {bid.title || "Untitled Product"}
                          </p>
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <p className="font-semibold text-gray-800">
                            {bid.seller_name || bid.email?.split('@')[0] || "Seller"}
                          </p>
                          <p className="text-xs text-gray-500">{bid.email || "N/A"}</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="py-4 px-6 font-extrabold text-purple-700 text-base">
                      ${Number(bid.bid_price || bid.price_min || 0).toLocaleString()}
                    </td>
                    ...
                    <td className="py-4 px-6 text-center">
                      <button
                        ...
                        disabled={bid.status?.toLowerCase() === 'accepted'}
                        ...
                        title={bid.status?.toLowerCase() === 'accepted' ? "Accepted bids cannot be removed" : "Withdraw Bid"}
                      >
                        <svg
                          className="w-5 h-5"
                          fill="none"
